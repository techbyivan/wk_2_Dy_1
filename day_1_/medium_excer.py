...
# list_a = ['overview', 'baseball', 'yes'] 

# print("Contents Of List Are : \n" + str(list_a)) 

# result = len(min(list_a, key = len)) 
# print("Length of shortest string is : \n" + str(result)) 
...
# list_2 = ['overview', 'trash', 'yes'] 

# print("Contents Of List Are : \n" + str(list_2)) 

# result = len(max(list_2, key = len)) 
# print("Length of longest string is : \n" + str(result)) 
